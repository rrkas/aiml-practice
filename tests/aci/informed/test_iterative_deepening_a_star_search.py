...
from src.aci.search.informed.iterative_deepening_a_star_search import (
...
if __name__ == "__main__":
    ...
    sol = iterative_deepening_a_star_search(problem=problem, debug=True)
    print(sol)
    if sol:
        print(problem.path_cost(sol, debug=True))
